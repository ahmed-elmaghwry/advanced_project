...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T dataResponse) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T dataResponse)? success,
...
class __$$SuccessImplCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$SuccessImpl<T>(
      dataResponse: freezed == dataResponse
          ? _value.dataResponse
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl({required this.dataResponse});
  ...
  @override
  String toString() {
    return 'LoginState<$T>.success(dataResponse: $dataResponse)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.dataResponse, dataResponse));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(dataResponse));
...
abstract class Success<T> implements LoginState<T> {
  const factory Success({required final T dataResponse}) = _$SuccessImpl<T>;
